                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <asp:Button Text="❌"  CssClass="btn btn-primary" runat="server" ID="btnQuitarFavoritos" CommandArgument='<%#Eval("Id") %>' CommandName="idArticulo" OnClick="btnQuitarFavoritos_Click"/>
                                </div>
                            </div>
                        </div>
                    </ItemTemplate>
